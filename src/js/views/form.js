...
elements.form.addEventListener('input', function (e) {
    ...
    switch (true) {
        case inputName === 'email':
            FormController.handleValidation(FormController.validateEmail(value), input)
            break;
        case inputName === 'phone':
            FormController.handleValidation(FormController.validatePhone(value), input)
            break;
    ...
    const isFormValid = elements.form.querySelectorAll('.invalid').length === 0 && elements.form.querySelectorAll('.touched').length >= 4;
...
elements.form.addEventListener('submit', function (e){
    ...
    FormController.handleFormSubmit(formData, FormController.handleFormSubmitted(this));
